...
public class quiz3 extends AppCompatActivity {
    ...
    Button bNext;
    int score;
    String RepCorrect="un professeur";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Toast.makeText(this, intent.getStringArrayListExtra("log").toString()+"", Toast.LENGTH_SHORT).show();
        ...
        bNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(rg.getCheckedRadioButtonId()==-1){
                    ...
                    //intent.putExtra("log",intent.getStringArrayListExtra("log").add(rb.getText().toString()));
